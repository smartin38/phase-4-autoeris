...
function AuthLoginForm({ username, setUsername, password, setPassword, signin }) {
    return (
            ...
            <div className="flex justify-center self-center  z-10">
                <div className="p-12 bg-gradient-to-b from-gray-900 via-gray-900 to-blue-900 mx-auto rounded-3xl w-96 ">
                    ...
                    <div className="space-y-6">
                        <Input value={username} onChange={(e) => setUsername(e.target.value)} className=" w-full text-sm text-white px-4 py-3 bg-gray-900 border border-gray-700 rounded-lg focus:outline-none focus:border-purple-400" type="username" placeholder="Username"></Input>
